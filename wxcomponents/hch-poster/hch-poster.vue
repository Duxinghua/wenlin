...
export default {
  ...
  methods: {
    ...
    creatTitle(ctx,canvasAttr){
	  ...
	  let top = 30
      let textY = this.drawText(ctx, canvasAttr.title,canvasAttr.marginLR+canvasAttr.innerLR, top + (this.system.w-2*canvasAttr.marginLR-2*canvasAttr.innerLR)/canvasAttr.posterRatio+2*canvasAttr.innerLR+canvasAttr.marginTB, this.system.w-2*canvasAttr.marginLR-2*canvasAttr.innerLR, canvasAttr.titleLineHeight)
      ctx.draw(true)
      return textY
    },
